...
{
    /// <inheritdoc />
    public partial class AddEntitiesWithConfurationsAndSeddData : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfEconomySeats = table.Column<int>(type: "int", nullable: false),
                    ...
                    AdultBaggage = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ChildBaggage = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EconomyToken = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BusinessToken = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FirstClassToken = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeatsToken = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlightReservation", x => new { x.FlightsId, x.ReservationsId });
                    table.ForeignKey(
                        name: "FK_FlightReservation_Flights_FlightsId",
                        column: x => x.FlightsId,
                        principalTable: "Flights",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FlightReservation_Reservations_ReservationsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlightReservation_ReservationsId",
